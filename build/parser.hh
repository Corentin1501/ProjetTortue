...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    REPETE = 273,                  // REPETE
    ENDREPETE = 274,               // ENDREPETE
    MUR = 275,                     // MUR
    NOT = 276,                     // NOT
    VIDE = 277,                    // VIDE
    DEVANT = 278,                  // DEVANT
    DERRIERE = 279,                // DERRIERE
    DROITE = 280,                  // DROITE
    GAUCHE = 281,                  // GAUCHE
    ...
    JARDIN = 284,                  // JARDIN
    FILE = 285,                    // FILE
    FONCTION = 286,                // FONCTION
    ENDFONCTION = 287,             // ENDFONCTION
    NAME = 288,                    // NAME
    ARGUMENTS = 289,               // ARGUMENTS
    NUMBERARG = 290,               // NUMBERARG
    COULEUR = 291,                 // COULEUR
    COULEURMOTIF = 292,            // COULEURMOTIF
    HEXCODE = 293,                 // HEXCODE
    NUMBER = 294,                  // NUMBER
    NEG = 295                      // NEG
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_ENDIF = 15,                            // ENDIF
        S_WHILE = 16,                            // WHILE
        S_ENDWHILE = 17,                         // ENDWHILE
        S_REPETE = 18,                           // REPETE
        S_ENDREPETE = 19,                        // ENDREPETE
        S_MUR = 20,                              // MUR
        S_NOT = 21,                              // NOT
        S_VIDE = 22,                             // VIDE
        S_DEVANT = 23,                           // DEVANT
        S_DERRIERE = 24,                         // DERRIERE
        S_DROITE = 25,                           // DROITE
        S_GAUCHE = 26,                           // GAUCHE
        ...
        S_JARDIN = 29,                           // JARDIN
        S_FILE = 30,                             // FILE
        S_FONCTION = 31,                         // FONCTION
        S_ENDFONCTION = 32,                      // ENDFONCTION
        S_NAME = 33,                             // NAME
        S_ARGUMENTS = 34,                        // ARGUMENTS
        S_NUMBERARG = 35,                        // NUMBERARG
        S_COULEUR = 36,                          // COULEUR
        S_COULEURMOTIF = 37,                     // COULEURMOTIF
        S_HEXCODE = 38,                          // HEXCODE
        S_NUMBER = 39,                           // NUMBER
        S_40_ = 40,                              // '-'
        S_41_ = 41,                              // '+'
        S_42_ = 42,                              // '*'
        ...
        S_tortues = 49,                          // tortues
        S_jardin = 50,                           // jardin
        S_numeroDeTortue = 51,                   // numeroDeTortue
        S_finDeLigne = 52,                       // finDeLigne
        S_numeroOuRien = 53,                     // numeroOuRien
        S_deplacement = 54,                      // deplacement
        S_avancer = 55,                          // avancer
        S_reculer = 56,                          // reculer
        S_sauter = 57,                           // sauter
        S_tourner = 58,                          // tourner
        S_position = 59,                         // position
        S_condition = 60,                        // condition
        S_conditionelle = 61,                    // conditionelle
        S_boucle = 62,                           // boucle
        S_color = 63,                            // color
        S_argumentsOuRien = 64,                  // argumentsOuRien
        S_fonction = 65,                         // fonction
        S_expression = 66,                       // expression
        S_operation = 67                         // operation
      };
    };
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        YY_ASSERT (tok == token::YYEOF
                   ...
                   || (token::FONCTION <= tok && tok <= token::ENDFONCTION)
...
#endif
      {
        YY_ASSERT (tok == token::NUMTORTUE
                   || tok == token::FILE
                   || (token::NAME <= tok && tok <= token::NUMBERARG)
                   || tok == token::HEXCODE);
      }
    };
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_TOURNED (location_type l)
      {
        return symbol_type (token::TOURNED, std::move (l));
      }
#else
      static
      symbol_type
      make_TOURNED (const location_type& l)
      {
        return symbol_type (token::TOURNED, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_TOURNEG (location_type l)
      {
        return symbol_type (token::TOURNEG, std::move (l));
      }
#else
      static
      symbol_type
      make_TOURNEG (const location_type& l)
      {
        return symbol_type (token::TOURNEG, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_ENDREPETE (location_type l)
      {
        return symbol_type (token::ENDREPETE, std::move (l));
      }
#else
      static
      symbol_type
      make_ENDREPETE (const location_type& l)
      {
        return symbol_type (token::ENDREPETE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_ENDFONCTION (location_type l)
      {
        return symbol_type (token::ENDFONCTION, std::move (l));
      }
#else
      static
      symbol_type
      make_ENDFONCTION (const location_type& l)
      {
        return symbol_type (token::ENDFONCTION, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_ARGUMENTS (std::string v, location_type l)
      {
        return symbol_type (token::ARGUMENTS, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_ARGUMENTS (const std::string& v, const location_type& l)
      {
        return symbol_type (token::ARGUMENTS, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_NUMBERARG (std::string v, location_type l)
      {
        return symbol_type (token::NUMBERARG, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_NUMBERARG (const std::string& v, const location_type& l)
      {
        return symbol_type (token::NUMBERARG, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
